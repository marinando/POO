...
public class Main {
	...
	public static void main(String[] args) {
		...
		if (cliente1.mostrarSaldo() < saldoInicial) {
			System.out.println("saque realizado com sucesso da conta do cliente1 " + cliente1.getNome() + " novo saldo "
		...
		if ((saldoInicial2 + 500.00) == cliente2.mostrarSaldo()) {
			System.out.println("deposito realizado com sucesso da conta do cliente2 " + cliente2.getNome()
					+ " novo saldo " + cliente2.mostrarSaldo());
		}

		System.out.println("clientes: ");
		for (Cliente item : clientesLista) {
			System.out.println("nome: " + item.getNome() + "nascimento: " + item.getDataNasc() + " email: "
					+ item.getEmail() + " nrConta: " + item.getNrConta() + " saldo: " + item.mostrarSaldo());
		}

		System.out.println("funcionarios: ");
		for (Funcionario item : funcionariosLista) {
			System.out.println(
					"nome: " + item.getNome() + "nascimento: " + item.getDataNasc() + " email: " + item.getEmail()
							+ " contratacao: " + item.getDataContratacao() + " registro: " + item.getNrRegistro());
		}
	}
